...
export class Hud {
  constructor(root) {
    ...
    root.append(this.bubbles, this.pops, this.cross, this.charge, h('div', { class: 'topbar' }, this.money, this.clock), this.tickets, this.prompt, this.mini, this.lock, this.leave, this.summary);
